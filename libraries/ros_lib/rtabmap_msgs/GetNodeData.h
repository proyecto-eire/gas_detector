...
static const char GETNODEDATA[] = "rtabmap_msgs/GetNodeData";
  ...
  class GetNodeDataResponse : public ros::Msg
  {
    public:
      ...
      typedef rtabmap_msgs::NodeData _data_type;
      _data_type st_data;
      _data_type * data;
    ...
    virtual int deserialize(unsigned char *inbuffer) override
    {
      ...
      if(data_lengthT > data_length)
        this->data = (rtabmap_msgs::NodeData*)realloc(this->data, data_lengthT * sizeof(rtabmap_msgs::NodeData));
      data_length = data_lengthT;
      for( uint32_t i = 0; i < data_length; i++){
      offset += this->st_data.deserialize(inbuffer + offset);
        memcpy( &(this->data[i]), &(this->st_data), sizeof(rtabmap_msgs::NodeData));
      }
     return offset;
    }

    virtual const char * getType() override { return GETNODEDATA; };
    virtual const char * getMD5() override { return "b11b4a96c2ae402c3deff196e5f84cd3"; };
