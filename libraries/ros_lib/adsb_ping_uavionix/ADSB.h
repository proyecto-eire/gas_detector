#ifndef _ROS_adsb_ping_uavionix_ADSB_h
#define _ROS_adsb_ping_uavionix_ADSB_h
...
namespace adsb_ping_uavionix
{

  class ADSB : public ros::Msg
  {
    public:
    ...
    virtual const char * getType() override { return "adsb_ping_uavionix/ADSB"; };
